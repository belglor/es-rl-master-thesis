...
ID="E029-VO-S4"
COMMON_IN="--id ${ID} --workers ${CORES} --algorithm sNES --env-name MNIST --model MNISTNet --perturbations 100 --optimizer SGD --momentum 0.9 --lr 0.05 --max-generations 5000 --batch-size 1000 --safe-mutation SUM --chkpt-int 1200 --lr-scheduler ExponentialLR --gamma 1"
declare -a INPUTS=(
				   ...
				   # Uses momentum 0.9 and dampening 0.5 on beta
SCRIPT="run_hpc.sh"
REPEATS=30
