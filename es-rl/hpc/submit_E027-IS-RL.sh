...
ID="E027-IS-RL"
COMMON_IN="--id ${ID} --workers ${CORES} --algorithm sNES --optimize-sigma None --env-name Freeway-v0 --model DQN --optimizer SGD --lr 0.05 --cov-lr 0.05 --max-generations 1000 --batch-size 20000 --safe-mutation SUM --chkpt-int 1200 --lr-scheduler ExponentialLR --gamma 1"
declare -a INPUTS=(
