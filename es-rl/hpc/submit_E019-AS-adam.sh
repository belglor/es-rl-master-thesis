...
ID="E019-AS"
COMMON_IN="--id ${ID} --workers ${CORES} --algorithm sNES --optimize-sigma single --env-name MNIST --model MNISTNet --optimizer Adam --lr 0.05 --cov-lr 0.05 --max-generations 1000 --batch-size 1000 --safe-mutation SUM --chkpt-int 1200 --lr-scheduler ExponentialLR --gamma 1"
declare -a INPUTS=(
