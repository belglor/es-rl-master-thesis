...
ID="E007-MNIST"
COMMON_IN="--id ${ID} --algorithm ES --optimizer SGD --lr-scheduler ExponentialLR --gamma 0.99970 --lr 0.02 --env-name MNIST --max-generations 10000 --batch-size 1000 --safe-mutation SUM"
declare -a INPUTS=(
				   "$COMMON_IN"
				   )
SCRIPT="run_hpc.sh"
