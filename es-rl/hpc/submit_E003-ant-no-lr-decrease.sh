...
declare -a INPUTS=(
				   "$COMMON_IN --lr 0.001 --pertubations 40" # Comparative grounds
				   "$COMMON_IN --lr 0.001 --pertubations 40 --no-antithetic" # As many pertubations but not antithetic
				   "$COMMON_IN --lr 0.0002 --pertubations 20 --no-antithetic" # Removing the antithetic pertubations, such that half remains.
				   )
SCRIPT="run_hpc.sh"
REPEATS=10
