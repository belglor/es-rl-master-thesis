...
ID="E018-SM"
COMMON_IN="--id ${ID} --workers ${CORES} --algorithm sNES --optimize-sigma single --env-name MNIST --model MNISTNet --optimizer Adam --lr 0.05 --cov-lr 0.05 --perturbations 100 --max-generations 1000 --batch-size 1000 --chkpt-int 1200 --lr-scheduler ExponentialLR --gamma 1"
declare -a INPUTS=(
