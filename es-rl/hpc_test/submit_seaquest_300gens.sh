...
ID="E012-Seaquest_300gens"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name Seaquest-v0 --model DQN --batch-size 1000 --safe-mutation None --max-generations 300"
declare -a INPUTS=(
