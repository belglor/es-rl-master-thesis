...
ID="E013-Seaquest_300gens_naturgrad"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name Seaquest-v0 --model DQN --batch-size 1000 --safe-mutation None --max-generations 300 --use-naturgrad --lr 1"
declare -a INPUTS=(
