...
ID="CartPole_per-weight_m09"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name CartPole-v0 --model ClassicalControlFNN --batch-size 1000 --safe-mutation None --optimize-sigma per-weight --lr 0.05 --momentum 0.9"
declare -a INPUTS=(
				   "$COMMON_IN "
