...
ID="E017-Seaquest_none_no_ranktransform"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name Seaquest-v0 --model DQN --batch-size 1000 --safe-mutation None --optimize-sigma None --no-ranktransform"
declare -a INPUTS=(
				   "$COMMON_IN"
