...
ID="E020-Seaquest_per-layer"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name Seaquest-v0 --model DQN --batch-size 1000 --safe-mutation None --optimize-sigma per-layer"
declare -a INPUTS=(
				   "$COMMON_IN"
