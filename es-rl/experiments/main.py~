...
def parse_inputs():
    ...
    parser.add_argument('--baseline_mu', action='store_true', default=False, help='Use baseline for the mu parameter')
    parser.add_argument('--baseline_sigma', action='store_true', default=False, help='Use baseline for the sigma parameter')
