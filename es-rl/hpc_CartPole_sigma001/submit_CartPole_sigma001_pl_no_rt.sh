...
ID="CartPole_sigma001_per-layer_no_ranktransform"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name CartPole-v0 --model ClassicalControlFNN --batch-size 1000 --safe-mutation None --optimize-sigma per-layer --no-ranktransform --sigma 0.01"
declare -a INPUTS=(
				   "$COMMON_IN"
