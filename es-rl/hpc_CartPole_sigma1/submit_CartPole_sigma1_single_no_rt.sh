...
ID="CartPole_sigma1_single_no_ranktransform"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name CartPole-v0 --model ClassicalControlFNN --batch-size 1000 --safe-mutation None --optimize-sigma single --no-ranktransform --sigma 1"
declare -a INPUTS=(
				   "$COMMON_IN"
