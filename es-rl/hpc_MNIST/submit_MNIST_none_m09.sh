...
ID="MNIST_none_m09"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name MNIST --model MNISTNet --batch-size 1000 --safe-mutation None --optimize-sigma None --momentum 0.9"
declare -a INPUTS=(
				   "$COMMON_IN "
