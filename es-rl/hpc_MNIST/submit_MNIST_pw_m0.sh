...
ID="MNIST_pw_m0"
COMMON_IN="--id ${ID} --algorithm sNES --optimizer SGD --lr-scheduler ExponentialLR --gamma 1 --env-name MNIST --model MNISTNet --batch-size 1000 --safe-mutation None --optimize-sigma per-weight --momentum 0 --lr 1"
declare -a INPUTS=(
				   "$COMMON_IN "
